    ...
    <table class="table table-borderless shopping-cart-table">
        <thead>
            <tr>
                ...
                <th><?php echo e(trans('storefront::cart.table.unit_price')); ?></th>
                <th><?php echo e(trans('storefront::cart.table.quantity')); ?></th>
        ...
        <tbody>
            <tr v-for="cartItem in cart.items" :key="cartItem.id">
                ...
                <td>
                    <label><?php echo e(trans('storefront::cart.table.unit_price:')); ?></label>

                    <span class="product-price" v-html="cartItem.unitPrice.inCurrentCurrency.formatted"></span>
                </td>

                <td>
                    <label><?php echo e(trans('storefront::cart.table.quantity:')); ?></label>
...
<?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/cart/index/cart_items.blade.php ENDPATH**/ ?>