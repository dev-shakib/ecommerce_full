        ...
        <div class="order-summary-middle" :class="{ loading: loadingOrderSummary }">
            ...
            <div class="shipping-methods" v-cloak>
                ...
                <span class="error-message" v-else>
                    <?php echo e(trans('storefront::cart.shipping_method_is_not_configured')); ?>
...
<?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/checkout/create/order_summary.blade.php ENDPATH**/ ?>