    ...
    <div class="row">
        <div class="col-md-18">
            <div class="form-group ship-to-different-address-label">
                <div class="form-check">
                    ...
                    <label for="ship-to-different-address" class="form-check-label">
                        <?php echo e(trans('checkout::attributes.ship_to_a_different_address')); ?>
            ...
            <div class="ship-to-different-address-form" v-show="form.ship_to_a_different_address" v-cloak>
                <h4 class="section-title"><?php echo e(trans('storefront::checkout.shipping_details')); ?></h4>

                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            <label for="shipping-first-name">
                                <?php echo e(trans('checkout::attributes.shipping.first_name')); ?><span>*</span>
                            </label>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <label for="shipping-last-name">
                                <?php echo e(trans('checkout::attributes.shipping.last_name')); ?><span>*</span>
                            </label>
                    ...
                    <div class="col-md-18">
                        <div class="form-group">
                            <label for="shipping-address-1">
                                <?php echo e(trans('checkout::attributes.street_address')); ?><span>*</span>
                            </label>
                            ...
                            <input
                                ...
                                class="form-control"
                                placeholder="<?php echo e(trans('checkout::attributes.shipping.address_1')); ?>"
                            >
                        ...
                        <div class="form-group">
                            <input
                                ...
                                class="form-control"
                                placeholder="<?php echo e(trans('checkout::attributes.shipping.address_2')); ?>"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <label for="shipping-zip">
                                <?php echo e(trans('checkout::attributes.shipping.zip')); ?><span>*</span>
                            </label>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <label for="shipping-country">
                                <?php echo e(trans('checkout::attributes.shipping.country')); ?><span>*</span>
                            </label>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <label for="shipping-state">
                                <?php echo e(trans('checkout::attributes.shipping.state')); ?><span>*</span>
                            </label>
                            ...
                            <select
                                ...
                                v-cloak
                            >
                                <option value=""><?php echo e(trans('storefront::checkout.please_select')); ?></option>
...
<?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/checkout/create/form/shipping_details.blade.php ENDPATH**/ ?>