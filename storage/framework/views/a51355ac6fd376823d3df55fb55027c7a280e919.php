    ...
    <tr class="option-row">
        ...
        <td>
            ...
            >
                ...
                >
                    <?php echo e(trans('option::options.form.price_types.fixed')); ?>
                ...
                >
                    <?php echo e(trans('option::options.form.price_types.percent')); ?>

                </option>
            </select>
        </td>
        <td class="text-center">
            <button type="button" class="btn btn-default delete-row" data-toggle="tooltip" title="<?php echo e(trans('option::options.form.delete_row')); ?>">
                <i class="fa fa-trash"></i>
            </button>
        </td>
    </td>
</script>
<?php /**PATH C:\laragon\www\ecommerce_full\Modules/Option/Resources/views/admin/options/templates/option/select_values.blade.php ENDPATH**/ ?>