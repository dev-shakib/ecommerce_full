...
<?php $__env->startSection('content'); ?>
    <compare-index :compare="<?php echo e($compare); ?>" inline-template>
        <div>
            <section class="compare-wrap">
                <div class="container" v-cloak>
                    <div class="table-responsive" v-if="hasAnyProduct">
                        <table class="table table-bordered compare-table">
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e(trans('storefront::compare.description')); ?></td>

                                    <td v-for="product in products" v-text="product.short_description || '-'"></td>
                                </tr>

                                <tr>
                                    <td><?php echo e(trans('storefront::compare.rating')); ?></td>
                                ...
                                <tr>
                                    <td><?php echo e(trans('storefront::compare.availability')); ?></td>

                                    <td v-for="product in products">
                                        <span class="badge badge-success" v-if="product.is_in_stock">
                                            <?php echo e(trans('storefront::compare.in_stock')); ?>

                                        </span>

                                        <span class="badge badge-danger" v-else>
                                            <?php echo e(trans('storefront::compare.out_of_stock')); ?>
                                ...
                                <tr>
                                    <td><?php echo e(trans('storefront::compare.actions')); ?></td>

                                    <td v-for="product in products">
                                        <button
                                            title="<?php echo e(trans('storefront::product_card.wishlist')); ?>"
                                        ...
                                        <button
                                            title="<?php echo e(trans('storefront::compare.add_to_cart')); ?>"
                    ...
                    <div class="empty-message" v-else>
                        ...
                        <h3><?php echo e(trans('storefront::compare.no_product')); ?></h3>
                    </div>
                </div>
            </section>

            <landscape-products
                title="<?php echo e(trans('storefront::product.related_products')); ?>"
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/compare/index.blade.php ENDPATH**/ ?>