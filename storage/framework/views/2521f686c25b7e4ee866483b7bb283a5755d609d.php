    ...
    <div class="slide">
        <div class="slide-header clearfix">
            ...
            <span class="pull-left">
                <?php echo e(trans('slider::sliders.slide.image_slide')); ?>
            ...
            <div class="slide-tabs tab-wrapper">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label for="slides-<%- slideNumber %>-direction">
                                        <?php echo e(trans('slider::attributes.direction')); ?>
                                    ...
                                    >
                                        <option value="left" <%= slide.direction === 'left' ? 'selected' : '' %>>
                                            <?php echo e(trans('slider::sliders.slide.form.directions.left')); ?>

                                        </option>

                                        <option value="right" <%= slide.direction === 'right' ? 'selected' : '' %>>
                                            <?php echo e(trans('slider::sliders.slide.form.directions.right')); ?>
                    ...
                    <div id="slider-<%- slideNumber %>-options" class="tab-pane fade in clearfix">
                        ...
                        <?php echo $__env->make('slider::admin.sliders.templates.partials.slide_caption', ['captionNumber' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('slider::admin.sliders.templates.partials.slide_caption', ['captionNumber' => 2], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('slider::admin.sliders.templates.partials.slide_call_to_action', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\ecommerce_full\Modules/Slider/Resources/views/admin/sliders/templates/slide.blade.php ENDPATH**/ ?>