                ...
                <div class="review-form-wrap">
                    <form @submit.prevent="addNewReview" @input="errors.clear($event.target.name)">
                        <div class="review-form">
                            <h4><?php echo e(trans('storefront::product.add_a_review')); ?></h4>

                            <div class="row">
                                <div class="col-md-18">
                                    <div class="form-group">
                                        <label><?php echo e(trans('storefront::product.review_form.your_rating')); ?><span>*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="name"><?php echo e(trans('storefront::product.review_form.name')); ?><span>*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="comment"><?php echo e(trans('storefront::product.review_form.comment')); ?><span>*</span></label>
                                    ...
                                    <div class="form-group p-t-5">
                                        ...
                                        <input type="text" name="captcha" v-model="reviewForm.captcha" class="captcha-input" placeholder="<?php echo e(trans('storefront::layout.enter_captcha_code')); ?>">
                                    ...
                                    >
                                        <?php echo e(trans('storefront::product.review_form.submit')); ?>
            ...
            <div class="col-xl-9 col-lg-18">
                <div class="user-review-wrap" :class="{ loading: fetchingReviews }">
                    <div class="empty-message" v-if="emptyReviews">
                        ...
                        <h4><?php echo e(trans('storefront::product.be_the_first_one_to_review_this_product')); ?></h4>
                    </div>
                    ...
                    <div class="user-review" v-for="review in reviews.data" v-else>
                        ...
                        <span class="review-approval" v-else><?php echo e(trans("review::messages.submitted_for_approval")); ?></span>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/products/show/tab_reviews.blade.php ENDPATH**/ ?>