<div class="billing-details">
    <h4 class="section-title"><?php echo e(trans('storefront::checkout.billing_details')); ?></h4>

    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                <label for="billing-first-name">
                    <?php echo e(trans('checkout::attributes.billing.first_name')); ?><span>*</span>
                </label>
        ...
        <div class="col-md-9">
            <div class="form-group">
                <label for="billing-last-name">
                    <?php echo e(trans('checkout::attributes.billing.last_name')); ?><span>*</span>
                </label>
        ...
        <div class="col-md-18">
            <div class="form-group">
                ...
                <input
                    ...
                    class="form-control"
                    placeholder="<?php echo e(trans('checkout::attributes.billing.address_1')); ?>"
                >
        ...
        <div class="col-md-9">
            <div class="form-group">
                <label for="billing-zip">
                    <?php echo e(trans('checkout::attributes.billing.zip')); ?><span>*</span>
                </label>
        ...
        <div class="col-md-9">
            <div class="form-group">
                <label for="billing-country">
                    <?php echo e(trans('checkout::attributes.billing.country')); ?><span>*</span>
                </label>
        ...
        <div class="col-md-9">
            <div class="form-group">
                <label for="billing-state">
                    <?php echo e(trans('checkout::attributes.billing.state')); ?><span>*</span>
                </label>
...
<?php /**PATH C:\laragon\www\ecommerce_full\Themes\Storefront\views/public/checkout/create/form/billing_details.blade.php ENDPATH**/ ?>